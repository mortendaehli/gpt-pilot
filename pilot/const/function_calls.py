...
ARCHITECTURE = {
    "definitions": [return_array_from_prompt("technologies", "technology", "technologies")],
    "functions": {"process_technologies": lambda technologies: technologies},
}

FILTER_OS_TECHNOLOGIES = {
    "definitions": [return_array_from_prompt("os specific technologies", "os specific technology", "technologies")],
    "functions": {"process_os_specific_technologies": process_os_technologies},
}
...
COMMANDS_TO_RUN = {
    "definitions": [return_array_from_prompt("commands", "command", "commands")],
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "command": command_definition(
                                    ...
                                    'Timeout in milliseconds that represent the approximate time the command takes to finish. This should be used only if the task is of a type "command". If you need to run a command that doesn\'t finish by itself (eg. a command to run an app), put the timeout to 3000 milliseconds. Remember, this is not in seconds but in milliseconds so likely it always needs to be greater than 1000.',
                                ),
                    ...
                    "tasks": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "command": command_definition(
                                    'Command that needs to be run to complete the current task. This should be used only if the task is of a type "command".',
                                    'Timeout in milliseconds that represent the approximate time the command takes to finish. This should be used only if the task is of a type "command". If you need to run a command that doesn\'t finish by itself (eg. a command to run an app), put the timeout to 3000 milliseconds. Remember, this is not in seconds but in milliseconds so likely it always needs to be greater than 1000.',
                                ),
                                "code_change_description": {
                                    "type": "string",
...
IMPLEMENT_CHANGES = {
    ...
    "functions": {"save_files": lambda files: files},
