# prompts/prompts.py
from pilot.const import common
from pilot.const.llm import END_RESPONSE, MAX_QUESTIONS
from pilot.logger.logger import logger
from pilot.utils.llm_connection import create_gpt_chat_completion
from pilot.utils.questionary import styled_select, styled_text
from pilot.utils.style import color_white_bold
from pilot.utils.utils import get_prompt, get_sys_message
...
def ask_for_main_app_definition(project):
    description = styled_text(project, "Describe your app in as much detail as possible.")
